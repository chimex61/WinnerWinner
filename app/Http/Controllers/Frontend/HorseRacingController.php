        ...
        if($odd_type != 'Win & Each Way'){
            ...
            foreach($horseOutcomes as $key => $val) {
                ...
                if ($horse_nam0 != "UNNAMED FAVOURITE" || $horse_nam0 != "UNNAMED 2nd FAVOURITE" || $horse_nam0 != "2nd Favourite" || $horse_nam0 != "MultiPosition") {
                    ...
                    if (strtoupper($horse_nam0) != strtoupper($horse_nam1)) {
                        $i=0;
                        $j=0;
                        $new_val="";
                ...
                if(empty($matches)){}else {
                    foreach($matches as $outcome_key => $outcome_val) {
                        ...
                        $evnt_label = explode("|", $outcome_key)[0];
                        $evnt_outcome = explode("|", $outcome_key)[1];
                        ...
                        where('event_id', '=', $event_id)
                            ...
                            ->where('outcome_id', '=', explode("|", $outcome_key)[1])
                        ...
                        if ($table_type !== " red") {
                            #dd('stop');
                            $get_odd_output .= "<td  onclick=\"get_bet_count('{$evntid}','{$evnt_outcome}','{$venue_name}','{$evnt_label}','{$odd_type}');\">
