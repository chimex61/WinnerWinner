...
class OutcomeWilliamHillsData extends Command {
    ...
    public function WilliamHillsOutcomeData($apiID)
    {
        ...
        $getEvents = $this->eventMaster->where('api_id', $this->api_id, '=')->where('date_stamp', $today_stamp, '=')->get();
        foreach ($getEvents as $getEvent) {
            ...
            $venue_id_array[$getEvent->event_id]	= $getEvent->venue_id;
        }
...
#dd($event_id);
                   ...
                   # dd($venue_id_array);
                   # $venue_ids = $venue_id_array[$event_id];
